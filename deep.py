...
class ArcticDeepLearning:
    ...
    def prepare_lstm_data(self, sequence_length=12):
        ...
        # Reshape X to include feature dimension: (samples, timesteps, features)
...
def main():
    ...
    print("\nTraining complete. Models saved as 'best_cnn_model.keras' and 'best_lstm_autoencoder.keras'")
